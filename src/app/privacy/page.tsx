  ...
  return (
    <div className="min-h-screen bg-[#111318] text-white font-sans selection:bg-[#111318] selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <header className="mb-16 border-b border-[#222530] pb-8">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-[#FFD21A] font-heading">
            Política de Privacidad y Tratamiento de Datos
          </h1>
          <p className="text-lg text-[#9CA3AF] font-normal">
        ...
        <article className="prose prose-lg max-w-none text-white space-y-12">
          
          <section>
            <h2 className="text-2xl font-bold text-[#FFD21A] mb-4 flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A]">1.</span> Marco Legal
            </h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#FFD21A] mb-4 flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A]">2.</span> Información Recopilada
            </h2>
            ...
            <ul className="list-disc pl-6 space-y-2 text-[#9CA3AF]">
              <li><strong className="text-white">Datos de Identidad:</strong> Nombre, apellido, fecha de nacimiento y número de DNI.</li>
              <li><strong className="text-white">Datos de Contacto y Ubicación:</strong> Número de teléfono/WhatsApp, localidad y dirección postal exacta de entrega.</li>
              <li><strong className="text-white">Datos Patrimoniales:</strong> Ocupación, comprobantes de ingresos (recibos de sueldo, comprobantes de monotributo) y referencias personales o comerciales con fines de evaluación financiera.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-[#FFD21A] mb-4 flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A]">3.</span> Uso de los Datos
            </h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#FFD21A] mb-4 flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A]">4.</span> Red de Afiliados Independientes
            </h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#FFD21A] mb-4 flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A]">5.</span> Seguridad
            </h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#FFD21A] mb-4 flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A]">6.</span> Derechos del Usuario
            </h2>
            <p className="leading-relaxed">
