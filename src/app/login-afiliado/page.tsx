...
export default function LoginPage() {
 ...
 <a href="/red-afiliados" className="absolute top-8 left-6 md:left-12 text-zinc-500 hover:text-yellow-400 flex items-center gap-2 text-sm font-bold transition-colors z-50">← Volver a Red de Afiliados</a>
