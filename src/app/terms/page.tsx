  ...
  return (
    <div className="min-h-screen bg-[#F7F3EC] text-[#1F2928] font-sans selection:bg-[#173E3B] selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <header className="mb-12 border-b border-[#DED8CF] pb-8">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-[#173E3B] font-heading">
            Términos y Condiciones Generales de Servicio
          </h1>
          <p className="text-sm md:text-base text-[#68706E] font-normal leading-relaxed">
        ...
        <article className="space-y-10 text-[#1F2928]">
          
          {/* CLAUSULA 1 */}
          <section className="bg-[#FFFDFC] border border-[#DED8CF] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#173E3B] flex items-center gap-3 font-heading">
              <span className="text-[#B44E2A] font-bold font-mono">1.</span> Naturaleza de la Empresa y Objeto de los Servicios
            </h2>
            <p className="leading-relaxed text-sm text-[#68706E] text-justify">
              <strong className="text-[#1F2928]">LOOP GESTIÓN INTEGRAL S.R.L. es exclusivamente una empresa de prestación de servicios.</strong> Nuestra actividad principal consiste en la gestión administrativa y el mandato de compra de productos tecnológicos y electrodomésticos a pedido del cliente. Dejamos expresa constancia de que LOOP GESTIÓN INTEGRAL S.R.L. <strong className="text-[#B44E2A]">NO es una tienda minorista, NO es el fabricante de los bienes, y NO es una entidad financiera</strong> en los términos de la Ley de Entidades Financieras de la República Argentina.
            </p>
          </section>
          ...
          <section className="bg-[#FFFDFC] border border-[#DED8CF] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#173E3B] flex items-center gap-3 font-heading">
              <span className="text-[#B44E2A] font-bold font-mono">2.</span> Contrato de Mandato de Compra
            </h2>
            <p className="leading-relaxed text-sm text-[#68706E] text-justify">
          ...
          <section className="bg-[#FFFDFC] border border-[#DED8CF] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#173E3B] flex items-center gap-3 font-heading">
              <span className="text-[#B44E2A] font-bold font-mono">3.</span> Intermediación en Soporte Técnico y Logística
            </h2>
            <p className="leading-relaxed text-sm text-[#68706E] text-justify">
              LOOP GESTIÓN INTEGRAL S.R.L. ofrece un servicio de acompañamiento y gestión de soporte técnico ante fallas de fábrica. Esto implica que la empresa actuará como intermediario para gestionar la garantía oficial ante el fabricante o el proveedor original, asumiendo exclusivamente el servicio logístico de traslado físico del equipo desde el domicilio del cliente hacia los Centros de Servicio Técnico Oficial ubicados en la Ciudad Autónoma de Buenos Aires (CABA), así como su posterior retorno. <strong className="text-[#B44E2A]">LOOP GESTIÓN INTEGRAL S.R.L. no realiza reparaciones técnicas directas ni abre los equipos bajo ninguna circunstancia.</strong> Los tiempos de respuesta y resolución técnica dependen exclusivamente de las políticas del fabricante.
            </p>
          </section>
          ...
          <section className="bg-[#FFFDFC] border border-[#DED8CF] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#173E3B] flex items-center gap-3 font-heading">
              <span className="text-[#B44E2A] font-bold font-mono">4.</span> Obligación de Pago y Mora
            </h2>
            <p className="leading-relaxed text-sm text-[#68706E] text-justify">
          ...
          <section className="bg-[#FFFDFC] border border-[#DED8CF] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#173E3B] flex items-center gap-3 font-heading">
              <span className="text-[#B44E2A] font-bold font-mono">5.</span> Red de Afiliados Independientes
            </h2>
            <p className="leading-relaxed text-sm text-[#68706E] text-justify">
              La plataforma opera comercialmente con el apoyo de una red de <strong className="text-[#1F2928]">Afiliados Independientes</strong>. Estos son terceros ajenos a la estructura societaria de LOOP GESTIÓN INTEGRAL S.R.L. que prestan servicios de referenciación, scoring participativo y gestión de cobranza. <strong className="text-[#B44E2A]">Bajo ninguna circunstancia existe relación de dependencia laboral ni subordinación jurídica entre LOOP GESTIÓN INTEGRAL S.R.L. y el Afiliado Independiente.</strong> Cada Afiliado asume su propia responsabilidad civil y penal por sus actos, gestiones y omisiones durante su actividad comercial independiente.
            </p>
          </section>
          ...
          <section className="bg-[#FFFDFC] border border-[#DED8CF] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#173E3B] flex items-center gap-3 font-heading">
              <span className="text-[#B44E2A] font-bold font-mono">6.</span> Jurisdicción y Ley Aplicable
            </h2>
            <p className="leading-relaxed text-sm text-[#68706E] text-justify">
        ...
        <footer className="mt-16 pt-8 border-t border-[#DED8CF] text-center text-xs text-[#68706E] space-y-3 flex flex-col items-center">
