...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-[#111318] text-white font-sans selection:bg-[#111318] selection:text-white">
      ...
      {/* NAVBAR SIMPLE */}
      <nav className="sticky top-0 z-50 bg-[#161922]/90 backdrop-blur-md border-b border-[#222530]">
        <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="text-[#9CA3AF] hover:text-[#FFD21A] flex items-center gap-2 text-sm transition-colors font-bold">
            <ArrowLeft className="w-5 h-5" /> Volver al inicio
          </Link>
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold text-[#FFD21A] font-heading">CUENTA <span className="text-[#FFD21A]">HOGAR</span></span>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <header className="mb-12 border-b border-[#222530] pb-8">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-[#FFD21A] font-heading">
            Términos y Condiciones Generales de Servicio
          </h1>
          <p className="text-sm md:text-base text-[#9CA3AF] font-normal leading-relaxed">
        ...
        <article className="space-y-10 text-white">
          ...
          {/* CLAUSULA 1 */}
          <section className="bg-[#161922] border border-[#222530] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#FFD21A] flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A] font-bold font-mono">1.</span> Naturaleza de la Empresa y Objeto de los Servicios
            </h2>
            <p className="leading-relaxed text-sm text-[#9CA3AF] text-justify">
              <strong className="text-white">LOOP GESTIÓN INTEGRAL S.R.L. es exclusivamente una empresa de prestación de servicios.</strong> Nuestra actividad principal consiste en la gestión administrativa y el mandato de compra de productos tecnológicos y electrodomésticos a pedido del cliente. Dejamos expresa constancia de que LOOP GESTIÓN INTEGRAL S.R.L. <strong className="text-[#FFD21A]">NO es una tienda minorista, NO es el fabricante de los bienes, y NO es una entidad financiera</strong> en los términos de la Ley de Entidades Financieras de la República Argentina.
            </p>
          </section>
          ...
          <section className="bg-[#161922] border border-[#222530] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#FFD21A] flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A] font-bold font-mono">2.</span> Contrato de Mandato de Compra
            </h2>
            <p className="leading-relaxed text-sm text-[#9CA3AF] text-justify">
          ...
          <section className="bg-[#161922] border border-[#222530] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#FFD21A] flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A] font-bold font-mono">3.</span> Intermediación en Soporte Técnico y Logística
            </h2>
            <p className="leading-relaxed text-sm text-[#9CA3AF] text-justify">
              LOOP GESTIÓN INTEGRAL S.R.L. ofrece un servicio de acompañamiento y gestión de soporte técnico ante fallas de fábrica. Esto implica que la empresa actuará como intermediario para gestionar la garantía oficial ante el fabricante o el proveedor original, asumiendo exclusivamente el servicio logístico de traslado físico del equipo desde el domicilio del cliente hacia los Centros de Servicio Técnico Oficial ubicados en la Ciudad Autónoma de Buenos Aires (CABA), así como su posterior retorno. <strong className="text-[#FFD21A]">LOOP GESTIÓN INTEGRAL S.R.L. no realiza reparaciones técnicas directas ni abre los equipos bajo ninguna circunstancia.</strong> Los tiempos de respuesta y resolución técnica dependen exclusivamente de las políticas del fabricante.
            </p>
          </section>
          ...
          <section className="bg-[#161922] border border-[#222530] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#FFD21A] flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A] font-bold font-mono">4.</span> Obligación de Pago y Mora
            </h2>
            <p className="leading-relaxed text-sm text-[#9CA3AF] text-justify">
          ...
          <section className="bg-[#161922] border border-[#222530] p-6 rounded-2xl shadow-sm space-y-3">
            <h2 className="text-xl font-bold text-[#FFD21A] flex items-center gap-3 font-heading">
              <span className="text-[#FFD21A] font-bold font-mono">6.</span> Jurisdicción y Ley Aplicable
            </h2>
            <p className="leading-relaxed text-sm text-[#9CA3AF] text-justify">
        ...
        <footer className="mt-16 pt-8 border-t border-[#222530] text-center text-xs text-[#9CA3AF] space-y-3 flex flex-col items-center">
