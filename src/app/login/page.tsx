...
export default function LoginPage() {
 ...
 <Link href="/" className="absolute top-8 left-6 md:left-12 text-[#9CA3AF] hover:text-[#FFD21A] flex items-center gap-2 text-sm font-bold transition-colors z-50">← Volver al Catálogo</Link>
      ...
      <div className="bg-[#161922] border border-[#222530] p-8 sm:p-10 rounded-3xl w-full max-w-md shadow-xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#FFD21A] mb-2 font-heading">Portal de Clientes</h1>
          <p className="text-[#9CA3AF] font-normal">{isLogin ? "Accede a tu cuenta" : "Únete y solicita tu crédito hoy"}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {!isLogin && (
            <div>
              <label className="block text-sm mb-1 text-white font-bold">DNI del Cliente</label>
              <input 
                type="text" 
                required
                value={dni}
          ...
          <button 
            type="submit" 
            disabled={cargando}
            className="w-full bg-[#111318] hover:bg-[#123230] text-white py-4 rounded-xl font-bold text-base uppercase tracking-wider transition-all disabled:opacity-50 mt-4 shadow-md shadow-[#173E3B]/20 active:scale-95"
          >
        ...
        <div className="mt-8 text-center border-t border-[#222530] pt-6">
          ...
          <button 
            ...
            className="text-[#FFD21A] font-bold hover:underline mt-2 text-sm"
          >
