    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <section className="pt-20 pb-20 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h1 className="text-5xl md:text-6xl font-black tracking-tighter mb-6 text-white">¿En qué te ayudamos?</h1>
          <p className="text-xl md:text-2xl text-yellow-400 font-light max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Columna 1 */}
          <div className="bg-zinc-800/40 border border-zinc-800 p-8 rounded-3xl flex flex-col items-start hover:border-zinc-800 transition-colors">
        ...
        <div className="mt-20 max-w-4xl mx-auto bg-zinc-950 border border-zinc-800 p-8 md:p-12 rounded-3xl text-center">
          <h4 className="text-2xl font-bold mb-6 text-white">Nuestro Compromiso:</h4>
          <ul className="text-left md:text-center text-zinc-300 space-y-4 font-medium text-lg">
            <li>✓ <strong className="text-yellow-400">Trato directo:</strong> hablás con nuestra Red de Afiliados Independientes, no con máquinas.</li>
            <li>✓ <strong className="text-yellow-400">Sin sorpresas:</strong> cuotas fijas, claras y en pesos desde el primer día.</li>
            <li>✓ <strong className="text-yellow-400">Servicio puerta a puerta:</strong> gestionamos, llevamos y resolvemos sin que salgas de tu casa.</li>
          </ul>
        </div>
      </section>
